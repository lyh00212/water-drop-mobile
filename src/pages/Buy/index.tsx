...
import { DISABLE_DEV } from '@/utils/constance'
...
const Buy = () => {
    ...
    const buyHandler = async () => {
        ...
        if (typeof WeixinJSBridge !== 'undefined') {
            const wxConfig = await getWxConfig(id, count, data.preferentialPrice * count)
            // 有限购
            if (!wxConfig) return
    ...
    if (showResult.showFail) {
        return <FailResult price={data.preferentialPrice * count} orgName={data.org.name} />
    }
        ...
        <div className={style.container}>
            ...
            <div className={style.organization}>
                <div className={style.logo}>
                    <img alt="" src={data.org.logo} className={style.logoImg} />
                </div>
            ...
            <div className={style.price}>
                ...
                <span className={style.originalPrice}>￥{data.originalPrice * count}</span>
            </div>
            <Hr />
